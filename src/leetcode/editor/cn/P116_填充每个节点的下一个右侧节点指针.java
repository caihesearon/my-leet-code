...
public class P116_填充每个节点的下一个右侧节点指针 implements 二叉树 {
    public static void main(String[] args) {
        Solution solution = new P116_填充每个节点的下一个右侧节点指针().new Solution();
    ...
    class Solution {
        public Node connect(Node root) {
            // 题目意思：就是想将【完美二叉树】的每层所有子节点从左到右使用next连接起来，最右的next指向null
            if (root == null) {
                return root;
            }
